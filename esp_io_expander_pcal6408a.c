...
} esp_io_expander_pcal6408a_8bit_t;

static char* TAG = "pcal6408a_8";
...
esp_err_t esp_io_expander_new_i2c_pcal6408a_8bit(
  ...
  esp_io_expander_handle_t* handle) {
    ...
    esp_io_expander_pcal6408a_8bit_t* pcal
      = (esp_io_expander_pcal6408a_8bit_t*)calloc(1, sizeof(esp_io_expander_pcal6408a_8bit_t));
...
static esp_err_t read_input_reg(esp_io_expander_handle_t handle, uint32_t* value) {
    esp_io_expander_pcal6408a_8bit_t* pcal = (esp_io_expander_pcal6408a_8bit_t*)
      __containerof(handle, esp_io_expander_pcal6408a_8bit_t, base);
...
static esp_err_t write_output_reg(esp_io_expander_handle_t handle, uint32_t value) {
    esp_io_expander_pcal6408a_8bit_t* pcal = (esp_io_expander_pcal6408a_8bit_t*)
      __containerof(handle, esp_io_expander_pcal6408a_8bit_t, base);
    value &= 0xff; // Masquage sur 8 bits
    ...
    pcal->regs.output = (uint8_t)value;
    return ESP_OK;
}
...
static esp_err_t write_direction_reg(esp_io_expander_handle_t handle, uint32_t value) {
    ...
    pcal->regs.direction = (uint8_t)value;
    return ESP_OK;
}
